      ...
      <main className="w-full max-w-3xl space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            following terms and conditions of use (&quot;Terms of Service,&quot;
            &quot;Terms of Use,&quot; &quot;Terms&quot;), including those
            additional terms, conditions, and policies referenced herein and/or
            available by hyperlink. These Terms and Conditions of Use apply to
            all users of the application, including, without limitation, users
            who are browsers, aggregators, vendors, and/or customers.
          </p>
          <p className="text-sm md:text-base leading-relaxed">
            By visiting the application of our product&apos;s merchants, in
            particular OpenSea.io, you also agree to be bound by their terms and
            conditions of use.
          </p>
          <p className="text-sm md:text-base leading-relaxed">
            Please read these Terms carefully before accessing or using our
            application or buying any of our products. By accessing or using any
            part of the application, you agree to be bound by these Terms. If
            you do not agree to all the terms and conditions of this agreement,
            you may not access the application or use any services. If these
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            updates and/or changes to our application. It is your responsibility
            to check this page periodically for changes. Your continued use of
            or access to the application after we post any changes constitutes
            acceptance of those changes. Our application is hosted on
            Vercel.com.
          </p>
        </section>
        <section className="space-y-4">
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            Service is provided, without express written permission from us.
          </p>
        </section>
        <section className="space-y-4">
          <h3 className="text-base md:text-lg lg:text-xl font-semibold uppercase">
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            this application is provided for general information only and should
            ...
            timely sources of information. Any reliance on the material in this
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm md:text-base leading-relaxed">
            Prices for our products on merchant applications to which our links
            point, such as OpenSea.io, may be subject to change. Please note
            that we are not responsible for any of our products offered on
            OpenSea.io or other merchant applications when such offers originate
            from third parties (secondary market).
          </p>
        </section>
        <section className="space-y-4">
          <h3 className="text-base md:text-lg lg:text-xl font-semibold uppercase">
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            preview our products on our application. Please note that we reserve
            the right to discontinue such service and functionality, as well as
            any other service that we provide.
          </p>
          <p className="text-sm md:text-base leading-relaxed">
            We may also publish content on our social media accounts for
            information, promotion, and/or member discussions. Please note that
            we reserve the right to reject or ban any member that infringes on
            our rules. Ownership of any of our products does not confer the
            owner any right of access to such social media accounts, and we may
            block or ban the access of anyone we see fit, for any reason, and
            without any warning or notice. We may also terminate such accounts
            at any time at our sole discretion and without prior notice.
          </p>
          <p className="text-sm md:text-base leading-relaxed">
            ...
            and/or overall, may change or be changed according to circumstances
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            original NFT, including for such purposes. You warrant that you will
            not resell or transfer such merged NFT to a third party without also
            transferring the original NFT to the same third party unless your
            license for use and copyright allows you to do so. The use of such
            service and the resulting product, as well as its trade or
            transfers, are done under your sole responsibility and liability.
          </p>
          <p className="text-sm md:text-base leading-relaxed">
        ...
        <section className="space-y-4">
          ...
          <ol className="list-decimal list-outside space-y-2">
            <li className="text-sm md:text-base leading-relaxed">
              ...
              You can use the artwork when you are on a marketplace that allows
              the purchase and sale of your token, as long as the marketplace
              cryptographically verifies that you are the owner. You can also
              use your artwork to commercialize your merchandise, provided that
              you do not earn more than US$100,000 in revenue each year from
              doing so. However, you cannot modify the artwork, use the artwork
              to sell or promote third-party products, or use the artwork in
              connection with images of hatred, violence, or any other
              inappropriate behavior. You cannot try to trademark the artwork or
              otherwise acquire intellectual property rights in it.
            </li>
            <li className="text-sm md:text-base leading-relaxed">
            ...
            <li className="text-sm md:text-base leading-relaxed">
              The prices of crypto items are extremely volatile, and the prices
              of other digital items can adversely affect the prices of NFTs. We
              cannot guarantee that any purchaser of a crypto item will not lose
              money. In particular, many factors may affect the prices of NFTs,
              including (but not limited to) buyers’ interest, market
              fluctuation, technological changes, and the regulatory
              environment.
            </li>
            <li className="text-sm md:text-base leading-relaxed">
              We do not represent that our NFTs constitute a valuable purchase
              or that their value may increase with time. Please do not buy any
              of our products with any expectation of profit. When purchasing
              any of our NFTs, you accept and confirm that you do not expect
              profit. The NFTs that you buy from us are not investment
              contracts, and we disclaim any claims associated with any
              speculation you or other users may engage in connection with these
              NFTs. You are fully aware that the value of the NFTs may drop to
              zero and that they may become unsellable due to lack of demand. As
              a result, you are fully aware that you may lose the entirety of
              the value spent, as well as gas costs, transfer costs, and other
              purchasing costs.
            </li>
            <li className="text-sm md:text-base leading-relaxed">
              You are solely responsible if any taxes apply to your crypto items
              and transactions. We are not responsible for determining the taxes
              that may apply to you.
            </li>
            <li className="text-sm md:text-base leading-relaxed">
              We do not store or send your crypto items. Any transfer of crypto
              items occurs within the supporting blockchain.
            </li>
            <li className="text-sm md:text-base leading-relaxed">
              There are risks associated with using an Internet-based currency,
              including, but not limited to, the risks of hardware, software,
            ...
            <li className="text-sm md:text-base leading-relaxed">
              ...
              including, but not limited to, the risk of purchasing mislabeled
              assets, assets that are vulnerable to metadata decay, assets on
              smart contracts with bugs, and assets that may become
              non-transferable. Assets that you purchase may become inaccessible
              on our application or merchants’ applications. Under no
              circumstances shall the inability to view your assets serve as
              grounds for a claim against us.
            </li>
            <li className="text-sm md:text-base leading-relaxed">
              Please note that we reserve the right to amend our offers as
              described on this application, our social media accounts, our
              whitepaper, our about page, and/or other places where we advertise
              our products, including, but not limited to, the number of
              products on offer, the roadmap and calendars, and/or prices.
            </li>
            <li className="text-sm md:text-base leading-relaxed">
              You are also aware that there are fraud risks in buying NFTs, and
              you need to exercise great caution when accessing our links and
              applications. In particular, we are not responsible for any losses
              that you may suffer as a result of responding to third parties
              impersonating us or our application, or from parties offering
              copies of our artworks. In particular, we are not responsible for
              any third party contacting you with a direct message on your
              social media accounts, any third-party link in any message on your
              social media accounts, or any third-party link on any messaging or
              social media application or service, nor are we responsible for
              any losses that you may suffer as a result of responding to their
              solicitations.
            </li>
          </ol>
        </section>
        <section className="space-y-4">
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            third-party materials or applications, or any other materials,
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            carefully and make sure you understand them before you engage in any
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            promotions, offers, or availability. We reserve the right to correct
            any errors, inaccuracies, or omissions, and to change or update
            information or cancel any information in the Service or on any
            related application that is inaccurate at any time without prior
            notice (including after you have purchased one of our NFTs).
          </p>
          <p className="text-sm md:text-base leading-relaxed">
            We undertake no obligation to update, amend, or clarify information
            in the Service or on any related application, including, without
            limitation, pricing information, except as required by law. No
            specified update or refresh date applied in the Service or on any
            related application should be taken to indicate that all information
            in the Service or on any related application has been modified or
            updated.
          </p>
        </section>
        <section className="space-y-4">
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            operation of the Service, any related application, other
            ...
            any related application, other applications, or the Internet. We
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            or from us, or for any other claim related in any way to your use of
            ...
            countries, states, or jurisdictions do not allow the exclusion or
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            or unenforceable, such provision shall nonetheless be enforceable to
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            versions of the Terms). Any ambiguities in the interpretation of
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm md:text-base leading-relaxed">Waiver:</p>
          <p className="text-sm md:text-base leading-relaxed">
            ...
            not on a class basis, and claims of more than one customer cannot be
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            or the Republic of Indonesia Small Claims Tribunal.
          </p>
          <p className="text-sm md:text-base leading-relaxed">
            ...
            individual basis and not on a class basis, and claims of more than
            one customer cannot be arbitrated or litigated jointly or
          ...
          <p className="text-sm md:text-base leading-relaxed">
            The law of this arbitration clause shall be the law of the Republic
            of Indonesia. The seat of arbitration shall be Indonesia. The number
            ...
            the arbitrator—shall be strictly confidential.
          </p>
          <p className="text-sm md:text-base leading-relaxed">
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm md:text-base leading-relaxed">
            ...
            of Use at any time on this page.
          </p>
          <p className="text-sm md:text-base leading-relaxed">
